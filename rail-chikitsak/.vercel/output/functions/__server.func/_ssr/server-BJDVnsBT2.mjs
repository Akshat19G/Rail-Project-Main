...
import { n as createMiddleware, r as __exportAll } from "./server-BJDVnsBT.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CCfwkz1H.mjs");
...
var manifest = { "d3ec4dd35e3e325f74f1dae57691d0e168542742de5e2651ffc4c0742ff65814": {
	...
	importer: () => import("./demo-accounts.functions-DN9mfe_l.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Dwfe-FwJ.mjs").then((n) => n.t),
